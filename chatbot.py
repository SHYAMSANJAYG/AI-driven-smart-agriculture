...
# This pulls from the Streamlit "Secrets" dashboard
GROQ_API_KEY = st.secrets["GROQ_API_KEY"]
AGRO_API_KEY = st.secrets["AGRO_API_KEY"]   # free at agromonitoring.com
...
with st.sidebar:
    ...
    agro_key_input = st.text_input(
        ...
        value=AGRO_API_KEY,
        type="password",
        help="Free key at agromonitoring.com → Sign up → API Keys",
        ...
        try:
            ...
            if not features:
                ...
                if (fetch_lat, fetch_lon) != st.session_state.last_coords:
                    ...
                    active_key = agro_key_input.strip() if agro_key_input.strip() not in ["", "YOUR_AGROMONITORING_API_KEY_HERE"] else None
                    if active_key:
